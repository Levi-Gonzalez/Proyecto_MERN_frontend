...
const ModalEliminarTarea = () => {
  const { handleModalEliminarColaborador, modalEliminarColaborador, eliminarColaborador} = useProyecto();
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="mt-2">
                    ...
                    Una vez eliminada, esta persona no será parte de este proyecto
                    </p>
                  </div>
                </div>
              </div>
